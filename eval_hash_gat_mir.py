...
## dataset arguments
parser.add_argument('--dataroot', default='/home/jinlu/108.00.000/personal_nas/dataset/mirflickr25k/mirflickr/', help='path to dataset')
parser.add_argument('--trainFile',default = './dataset/mirflickr25k/mm2020_setting/mirflickr_train_w2v_new.txt', help='file of training set')
parser.add_argument('--databaseFile',default = './dataset/mirflickr25k/mm2020_setting/mirflickr_database_w2v.txt', help='file of database set')
parser.add_argument('--testFile', default = './dataset/mirflickr25k/mm2020_setting/mirflickr_test_w2v.txt',help = 'file of testing set')
...
parser.add_argument('--outf', default='./models/mirflickr/hash/model_64bit', help='folder to output images and model checkpoints')



opt = parser.parse_args()
opt.cuda = True
opt.dataroot = '/home/lujin/data/dataset/mirflickr25k/mirflickr/'
